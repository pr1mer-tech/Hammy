...
export function SwapDetails({
  ...
  const normalRate = Number.parseFloat(amountTo) / Number.parseFloat(amountFrom)
  const invertedRate = Number.parseFloat(amountFrom) / Number.parseFloat(amountTo)
  ...
  return (
    <div className="mt-3 text-sm bg-amber-50 rounded-lg p-3 space-y-2">
      ...
      <div className="flex justify-between items-center">
        ...
        <span className={cn("font-medium", getPriceImpactColor(priceImpact))}>
