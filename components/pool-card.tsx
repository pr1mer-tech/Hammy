...
export function PoolCard() {
	...
	const { data: allowanceA, refetch: refetchAllowanceA } = useReadContract({
		...
		query: {
			enabled: tokenA.address !== zeroAddress && !!address,
		},
	});
	...
	const { data: allowanceB, refetch: refetchAllowanceB } = useReadContract({
		...
		args: [address || zeroAddress, UNISWAP_V2_ROUTER],
		query: {
			enabled: tokenB.address !== zeroAddress && !!address,
		},
	});
							...
							BigInt(lpBalance.toString()) > 0 ? (
								<>
									...
									<div className="space-y-2 bg-blue-50/50 p-4 rounded-lg border border-blue-100">
										...
										/>
										<div className="text-sm text-right text-blue-700">
